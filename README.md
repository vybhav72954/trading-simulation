...
1. **XGBoost** -- Optuna-tuned (60 trials, TPE sampler, IC objective). max_depth=2, lr=0.030
...
jupyter notebook ml_momentum_strategy_final.ipynb
...
This project was built for a personal project. Use it however you want. If you write about the inverse-selection technique or the signal decay analysis, a mention would be appreciated.
